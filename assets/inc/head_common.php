<html>
	<head>
		<meta charset="utf-8">
			...
			<link rel="stylesheet" type="text/css" href="<?php echo $this->config->base_url();?>js/jquery-ui.css" />
			...
			<script type="text/javascript" src="<?php echo $this->config->base_url();?>js/jquery-ui.js"></script>
