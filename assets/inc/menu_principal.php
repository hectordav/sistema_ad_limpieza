            ...
            <ul class="nav navbar-nav">
              <li class="dropdown">
                ...
                <ul class="dropdown-menu" role="menu">
                 ...
                 <li><a href="<?php echo $this->config->base_url();?>index.php/proveedor">Proveedor</a></li>
              ...
              <li class="dropdown">
                ...
                <ul class="dropdown-menu" role="menu">
                    <li><a href="<?php echo $this->config->base_url();?>index.php/empresa">Configuracion de empresa</a></li>
                  <li><a href="<?php echo $this->config->base_url();?>index.php/usuario">Usuarios</a></li>
                  <li><a href="<?php echo $this->config->base_url();?>index.php/impresion">Configuracion de Impresion</a></li>
                  <li><a href="<?php echo $this->config->base_url();?>index.php/iva">Iva</a></li>
                  <li><a href="<?php echo $this->config->base_url();?>index.php/sucursal">Sucursales</a></li>
