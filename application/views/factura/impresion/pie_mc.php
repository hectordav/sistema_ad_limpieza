   ...
   <? }?>
    ...
    <?$sub_total_format= number_format($sub_total, 2,".",",");?>
        ...
        <? $total_fact= $iva+ $sub_total_descuento;?>
        <?$total_format= number_format($total_fact, 2,".",",");?>
        <?$sub_total_descuento_format= number_format($sub_total_descuento, 2,".","");?>
...
<table  align="right">
		...
		<TD border="1"ROWSPAN=4 width="70%">Recibi conforme: ________________________________</TD>
            ...
            <tr>
            <th align="right" width="40%"><strong>Descuento <?=$descuento?>%:</strong></th>
            <td align="right" width="10%"><?=$sub_total_descuento_format;?></td>
            </tr>
