...
<a href="<?php echo $this->config->base_url();?>index.php/presupuesto/menu_presupuesto"><button type="button"  class="btn btn-primary">Guardar</button></a>
...
<input type="text" name="" id="input" class="form-control" value="<?echo $id;?>" required="required" pattern="" title=""disabled="true">
...
<form action="<?= $this->config->base_url();?>index.php/presupuesto/agregar_producto"method="POST" role="form">
					<div class="form-group">
						<div class="input-group">
							<input type="hidden" name="lbl_num_fact" value="<?echo $id;?>">
