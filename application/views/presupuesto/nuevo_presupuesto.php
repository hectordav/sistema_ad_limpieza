...
<a href="<?php echo $this->config->base_url();?>index.php/presupuesto/menu_presupuesto"><button type="button"  class="btn btn-primary" disabled="true">Guardar</button></a>
...
<div class="col-md-6">
<div class="col-md-6">
<h4><span class="label label-default "><strong>Fecha</strong></span></h4>
...
<div class="col-md-6">
<h4><span class="label label-default "><strong># Presupuesto</strong></span></h4>
<input type="text" name="" id="input" class="form-control" value="<?= $id;?>" required="required" pattern="" title=""disabled="true">
...
<form action="<?= $this->config->base_url();?>index.php/presupuesto/agregar_producto"method="POST" role="form">
					<div class="form-group">
						<div class="input-group">
							<input type="hidden" name="lbl_num_fact" value="<?= $id;?>">
						...
						placeholder="Ingrese Producto" aria-describedby="sizing-addon2" required>
